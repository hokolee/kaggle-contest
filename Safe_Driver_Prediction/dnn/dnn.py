...
def train():
  with tf.device('/cpu:0'):
    train_fq = tf.train.string_input_producer(tf.train.match_filenames_once(train_dir + '/*tfrecords'))
    train_batch = read_batch(train_fq)
    validation_fq = tf.train.string_input_producer(tf.train.match_filenames_once(validation_dir + '/*tfrecords'), num_epochs=1)
